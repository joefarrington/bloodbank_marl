...
# TODO: Do we want the substitution penalty to be so high? In both cases?

n_products = 2
C = 1e10  # invalid substitution cost
max_useful_life = 3
# Based on Ensafian et al (2017), but consolidated to remove ABO
...
class RSPerishableTwoGymnax(RSPerishableGymnax):
    def __init__(
        self,
