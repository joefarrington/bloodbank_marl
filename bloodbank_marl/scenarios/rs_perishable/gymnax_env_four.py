...
max_useful_life = 3
# Based on Ensafian et al (2017), but consolidated to remove RhD
# This simplifications is not suppose to be reflective of practice, but just to get
# a smaller problem (e.g. actally, RhD more important)
...
product_probabilities = [0.45, 0.40, 0.11, 0.04]  # O  # A  # B  # AB
...
class RSPerishableFourGymnax(RSPerishableGymnax):
    def __init__(
        self,
